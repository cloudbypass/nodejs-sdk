...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.cloudbypass = factory(global.url));
  ...
  var isThenable = function isThenable(thing) {
    return thing && (isObject$1(thing) || isFunction(thing)) && isFunction(thing.then) && isFunction(thing["catch"]);
  };
  var utils$1 = {
    isArray: isArray,
  ...
  var cloudbypass = axios$1.create({});
  var cloudbypassInterceptorHelper = function cloudbypassInterceptorHelper(_axios) {
    ...
    _axios.interceptors.response.use(function (response) {
      ...
      if (error !== null && error !== void 0 && error.AxiosError && error.response && error.response.data) {
  ...
  cloudbypass.create = function (options) {
    return cloudbypassInterceptorHelper(axios$1.create(options));
  };
